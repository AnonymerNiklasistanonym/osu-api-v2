// Local imports
import { GameMode, GameModeInt } from "./game_mode.mjs"
import { RankStatus, RankStatusInt } from "./rank_status.mjs"
// Type imports
import type { User, UserCompact } from "./user.mjs"
import type { Failtimes } from "./failtimes.mjs"
...
export interface BeatmapsetCompactDescription {
    description: string
}

export interface BeatmapsetCompactGenre {
    id: number
    name: string
}

export interface BeatmapsetCompactLanguage {
    id: number
    name: string
}
...
export interface Beatmapset extends BeatmapsetCompact {
    ...
    /**
     * Should be required but can be undefined
     */
    has_favourited?: boolean
