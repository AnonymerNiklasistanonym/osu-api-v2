...
export const genericCheckObjectForUncheckedKeys = <DATA_TYPE extends object>(
    ...
    if (options?.ignoreUncheckedKeys) {
        return checkedKeys
    }
...
export interface DefaultCheckOptionsArray<ARRAY_TYPE extends unknown>
    ...
    elementCheckFunc?: (element: Readonly<ARRAY_TYPE>) => void
    hasLength?: number
    notEmpty?: boolean
}
...
export const genericCheckIfArray = <ARRAY_TYPE extends unknown>(
    ...
    genericCheckIfType(
        ...
        (input) => {
            ...
            if (options.elementCheckFunc !== undefined) {
                for (const element of input) {
                    options.elementCheckFunc(element)
                }
            }
        },
        input,
...
// eslint-disable-next-line @typescript-eslint/no-unnecessary-type-constraint
export interface DefaultCheckOptionsObject<OBJECT_TYPE extends unknown>
    extends DefaultCheckOptions<OBJECT_TYPE> {
    elementCheckFunc?: (element: Readonly<OBJECT_TYPE>) => void
}

// eslint-disable-next-line @typescript-eslint/no-unnecessary-type-constraint
export const genericCheckIfObject = <OBJECT_TYPE extends unknown>(
    input?: Readonly<OBJECT_TYPE> | null,
    options: Readonly<DefaultCheckOptionsObject<OBJECT_TYPE>> = {},
): void =>
    genericCheckIfType(
        "object",
        (element) => {
...
export const genericUnknownError = (
    input: unknown | null | undefined,
    options: Readonly<DefaultCheckOptions<unknown>> = {},
): void => {
    if (input === null && options.orNull === true) {
        expect(input).to.be.null
        if (options.checkedKeys && options.checkedKey) {
        ...
        expect.fail(
            `Found undocumented type '${
                options.checkedKey ?? "unknown"
